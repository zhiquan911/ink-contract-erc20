...
mod erc20 {
    ...
    impl Erc20 {
        #[ink(constructor)]
        pub fn new(symbol: Vec<u8>, decimals: u8, initial_supply: Balance) -> Self {
    ...
    mod tests {
        ...
        #[ink::test]
        fn new_works() {
            let contract = Erc20::new(b"BTC".to_vec(), 8, 100000000000000000);
            assert_eq!(contract.total_supply(), 100000000000000000);
        }

        #[ink::test]
        fn balance_works() {
            let contract = Erc20::new(b"BTC".to_vec(), 8, 100);
        ...
        #[ink::test]
        fn transfer_works() {
            let mut contract = Erc20::new(b"BTC".to_vec(), 8, 100);
            assert_eq!(contract.balance_of(AccountId::from([0x1; 32])), 100);
